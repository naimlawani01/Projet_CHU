                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                <span>engagé pour réussir</span>
                                <h1 class="cd-headline letters scale">Nous prennons soin de votre 
                                ...
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Prendre un rendez-vous <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
